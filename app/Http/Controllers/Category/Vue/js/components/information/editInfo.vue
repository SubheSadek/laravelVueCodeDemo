                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="_advertise_card _mar_b30">
                            <!-- Step one -->
                            <p class="_advertise_Sub_title _3title"><i class="fas fa-user"></i> Edit Information</p>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row" style="margin-bottom: 20px;">
                                                ...
                                                <div v-for="(item, i) in form.parent" :key="i" class="col-md-6 col-lg-6">
                                                        ...
                                                        <span v-for="(under_sub, sub_index) in item.subcategory" :key="sub_index">
                                                            ...
                                                            <p v-if="lastIndexSub == sub_index  && sub_index > 0" style="cursor:pointer;font-weight:bold;" @click="removeSub(i, sub_index)">Remove Subcategory</p> -->
                                                        </span>
                                                        ...
                                                        <Button v-if="form.parent.length > 0"  @click.native="removeParent(i)">Cancel</Button> <br><br>
                                        ...
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="_advertise_step_button">
                                                <Button @click.native="editInfo" :loading="isLoading" :disabled="isLoading" class="_btn1 _btn_150" style="padding-top:7px !important;padding-bottom:7px !important;">{{ isLoading ? 'Please wait . . .' : 'Save Changes'}}</Button>
                                            </div>
                                        </div>
...
export default {
	...
	methods:{
        addParent(i){
            ...
            // let ob = {category_id:0, subcategory_id:[], sub_subcategory_id:[], subcategories:[], subSubcategories:[]}
        ...
        async getSingleData(){
            ...
            const res = await this.callApi('get', `/category/getSingleEditData?info_id=${id}`)
            if(res.status == 200){
                this.form = res.data;
                this.form.info_id = res.data.id
                this.lastIndex = res.data.parent ? res.data.parent.length -1 : 0;
            }
        },
